...
m1 <- lm(I(log(BigDiamonds$price)) ~ I(BigDiamonds$carat^(1/3)), data = BigDiamonds$price)
m2 <- lm(m1 , ~ . + BigDiamonds$cut)
m3 <- lm(m2 , ~ . + BigDiamonds$Color)
m4 <- lm(m3 , ~ . + BigDiamonds$Clarity)
m5 <- lm(m4 , ~ . + BigDiamonds$Carat)
